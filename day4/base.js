...
function solve(part2 = false) {
    for (var i = 0 ; i < calledNumbers.length; i ++) {
        ...
        // I really wanted to have a single solve function.
        if (part2) {
...
// console.log("The answer for Alan's Part 1 is:", part1(adata));

// console.log("The answer for Alan's Part 2 is:", part2(adata));